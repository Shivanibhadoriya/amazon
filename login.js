...
function checkData() {
  ...
  if (email == "" || password == "") {
    ...
    if (!email.endsWith("@gmail.com")) {
      ...
      child.innerHTML = '<i class="fa-solid fa-circle-exclamation" style="color: #c20000;"></i>' + (email ==""? "Enter your mobile number or address":"wrong EmailId");
   ...
   // v is iterator for iterating each element of array
    if (user_records.some((v) => {
      ...
      if(current_user.length == 1){
        ...
        localStorage.setItem("email",current_user[0].email);  
      }else{
      ...
      let child = document.createElement("p");
      child.classList.add('empty-password');
      child.innerHTML = '<i class="fa-solid fa-circle-exclamation" style="color: #c20000;"></i>User doesn\'t exit';
      parent.insertBefore(child, parent.children[4]);  
    }
  }
}